  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setCurrentSection("dashboard"); // Redirect to Dashboard after login
      } else {
  ...
  return (
    <nav className="bg-gray-900 text-white shadow-lg">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        {/* Logo */}
        <div
          className="text-2xl font-bold tracking-wide cursor-pointer transition duration-300 hover:text-gray-400"
          onClick={() => setCurrentSection("home")}
        >
          <img src="/dllogo2.png" alt="Logo" className="h-10 w-[50px]" />
        </div>
